...
import { getProductionById, getProductions, saveProduction, updateProduction } from '../../../services/DailyProductionService'
    ...
    <React.Fragment>
      ...
      <div className={styles.productContainer}>
        ...
        <div style={{ display: 'flex', width: '100%', justifyContent: 'flex-start' }}>
          <CustomSelect style={{ width: '200px' }} value={production.productId} items={products} onChange={onChangeProduct} label="Produto" />
